                ...
                <div className="content">
                    ...
                    <div className="key-block">
                        <div className="r1_row flex" style={{ marginBottom: "10px" }}>
                            ...
                            <div className="key key__hiddenQuarter"></div>
                            ...
                            <div className="key key__hiddenQuarter"></div>
                            <div id="kF13" className="key key__side"><p>F13</p></div>
                        ...
                        <div className="r6_row flex">
                            <div id="kControlLeft" className="key key__1point5u"><p>CTRL</p></div>
                            <div className="key key__hidden"></div>
                            <div id="kAltLeft" className="key key__1point5u"><p>ALT</p></div>
                            <div id="kSpace" className="key key__space3">SPACE</div>
                            <div id="kAltRight" className="key key__1point5u"><p>ALT</p></div>
                            <div className="key key__hidden"></div>
                            <div id="kControlRight" className="key key__1point5u" style={{ marginRight: "12px" }}><p>CTRL</p></div>
